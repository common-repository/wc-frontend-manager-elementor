...
class WCFM_Elementor_Widget_StoreRating extends Widget_Base {
	...
	public function get_keywords() {
		return [ 'wcfm', 'star', 'rating', 'rate', 'review' ];
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => 5,
				'dynamic' => [
					'default' => $WCFMem->wcfmem_elementor()->dynamic_tags->tag_data_to_tag_text( null, 'wcfmem-store-rating-tag' ),
				],
			]
		);
    ...
    $rating = (float) $WCFMem->get_wcfmem_store_data( 'rating' );
